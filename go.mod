...
require (
	...
	github.com/cert-manager/cert-manager v1.16.5 // indirect
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20250528212017-1dce6213f6c0 // indirect
...
replace github.com/rabbitmq/cluster-operator/v2 => /
...
replace sigs.k8s.io/controller-runtime/tools/setup-envtest => sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20250308055145-5fe7bb3edc86

replace k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20250627150254-e9823e99808e //allow-merging

replace github.com/cert-manager/cmctl/v2 => github.com/cert-manager/cmctl/v2 v2.1.2-0.20241127223932-88edb96860cf

replace helm.sh/helm/v3 => helm.sh/helm/v3 v3.16.4
